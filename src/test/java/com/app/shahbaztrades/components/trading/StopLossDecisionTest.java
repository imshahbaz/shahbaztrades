...
import com.app.shahbaztrades.components.trading.TrailingStopPolicy.StopLossAction;
import static org.junit.jupiter.api.Assertions.assertEquals;

/** Covers the pure stop-loss/ATR decision logic in TrailingStopPolicy. */
class StopLossDecisionTest {

    private final TrailingStopPolicy policy = new TrailingStopPolicy();
    ...
    void noProfitYet_holdsEvenIfPriceDropped() {
        ...
        assertEquals(StopLossAction.NONE,
                policy.decide(98.0, 100.0, 100.0, null, NO_EXIT, OPEN));
    }
    ...
    void inProfitNoExitOrder_placesStopLoss() {
        ...
        assertEquals(StopLossAction.PLACE_STOP_LOSS,
                policy.decide(101.0, 100.0, 101.0, null, NO_EXIT, OPEN));
    }
    ...
    void inProfitAndDroppedFromPeak_squaresOff() {
        ...
        assertEquals(StopLossAction.SQUARE_OFF,
                policy.decide(100.5, 100.0, 102.0, null, HAS_EXIT, OPEN));
    }
    ...
    void inProfitAndMarketClosing_squaresOff() {
        ...
        assertEquals(StopLossAction.SQUARE_OFF,
                policy.decide(101.0, 100.0, 101.0, null, HAS_EXIT, CLOSING));
    }
    ...
    void atrTrailing_squaresOffBelowFloor() {
        ...
        assertEquals(StopLossAction.SQUARE_OFF,
                policy.decide(100.5, 100.0, 105.0, 10.0, HAS_EXIT, OPEN));
    }
    ...
    void atrTrailing_holdsAboveFloorWithExistingExit() {
        ...
        assertEquals(StopLossAction.NONE,
                policy.decide(104.0, 100.0, 105.0, 10.0, HAS_EXIT, OPEN));
    }

    @Test
    void flatPrice_holds() {
        assertEquals(StopLossAction.NONE,
                policy.decide(100.0, 100.0, 100.0, null, NO_EXIT, OPEN));
    }
}
