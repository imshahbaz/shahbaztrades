                ...
                <form id="calculator-form">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="sell-type" id="sell-exact" value="exact"
                                    checked>
                                <label class="btn btn-outline-primary" for="sell-exact">Exact Price</label>

                                <input type="radio" class="btn-check" name="sell-type" id="sell-percent"
                                    value="percent">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="quantity-type" id="qty-quantity"
                                    value="quantity" checked>
                                <label class="btn btn-outline-primary" for="qty-quantity">By Units</label>

                                <input type="radio" class="btn-check" name="quantity-type" id="qty-investment"
                                    value="investment">
                    ...
                    <div class="text-center mb-4">
                        <button type="button" class="btn btn-primary btn-lg px-5 shadow"
                            onclick="calculateReturns()">Calculate Returns</button>
                    </div>
                </form>
                ...
                <div id="results" style="display: none;">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between"><span>MTF Interest (15% p.a.):</span>
                                        <span class="fw-bold text-danger">&#x20B9; <span id="interest"></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    <h5 class="card-title text-muted mb-4 text-uppercase small fw-bold">Performance
                                        Metrics</h5>
                                    <div class="d-flex justify-content-between mb-2"><span>Gross Profit :</span> <span
                                            class="fw-bold">&#x20B9; <span id="profit"></span></span></div>
                                    <div class="d-flex justify-content-between mb-2"><span>Taxes & Charges :</span>
                                    ...
                                    <div class="d-flex justify-content-between"><span>Return on Margin :</span> <span
                                            class="fw-bold text-success"><span id="profit-percent"></span>%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
